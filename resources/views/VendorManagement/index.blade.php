        ...
        <div class="col-md-11 mx-auto">
            <div class="card">
                <h6 class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <i class="fal fa-coins"></i> <a href="{{ url('/VendorManagement') }} " class="link-dark text-decoration-none">
                            <h4>Vendor</h4>
                        </a>
                    </div>
                    @if(Auth::check() && Auth::user()->role_as==1)
                    <div class="btn-group" role="group" aria-label="button group">
                        <a class="btn btn-success" title="New Vendor" href="{{ url('/VendorManagement/create') }}">
                        <i class="bi bi-plus-circle-dotted"></i> New Vendor</a>
